...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0, user-scalable=no">
     ...
     <!-- Site Metas -->
    <title>SpringTECH - Solutions</title>  
    <meta name="keywords" content="">
    <meta name="description" content="">
    <meta name="author" content="">

    <!-- Site Icons -->
    <link rel="shortcut icon" href="images/favcon.ico" type="image/x-icon" />
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
					<ul class="nav navbar-nav navbar-right hidden-md hidden-sm hidden-xs">
                        <li><a  href="tel:+254791538749"class="call-button"><i class="fa fa-angle-double-right"></i>📞CALL NOW</a></li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right hidden-md hidden-sm hidden-xs">
                        <li><a href="https://wa.me/254791538749?text=Hello%2C%20I%20am%20interested%20in%20your%20services" class="whatsapp-button" target="_blank">
                        <i class="fa fa-whatsapp"></i> Chat on WhatsApp</a>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right menu-top">
                        ...
                        <li><a class="active" href="case.study.php">Case Study</a></li>                       
